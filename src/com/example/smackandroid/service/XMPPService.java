...
//        mXmppConnection = new XMPPTCPConnection(usrName, password,hostIp);
    ...
    private void registerPacketListener() {
    	// StanzaListener 为异步的；另有PacketCollector 为同步的 
        StanzaListener presenceTypelistener = new StanzaListener() {
            @Override
            public void processPacket(Stanza packet) throws SmackException.NotConnectedException {
                sendMsgNotification();
                Log.d(TAG,"接收到一条消息 PresenceTypeFilter.AVAILABLE - getStanzaId : " +  packet.getStanzaId());
            }
        };
        StanzaListener Messagelistener = new StanzaListener() {
            ...
            public void processPacket(Stanza packet) throws SmackException.NotConnectedException {
                ...
                if(packet instanceof org.jivesoftware.smack.packet.Message){
                    ...
                    Log.d(TAG,"接收到一条消息 - MessageWithBodiesFilter : " +  msg.getBody());
                }
            }
        };
//        mXmppConnection.addAsyncStanzaListener(listener,ForEveryMessage.INSTANCE);
       //  MessageWithBodiesFilter.INSTANCE，ForEveryMessage.INSTANCE 为不同的消息过滤器
     ...
     * @param usrName
     * @param pwd
     * @param callback 登录结果回调，不要在回调方法中操作UI
     */
